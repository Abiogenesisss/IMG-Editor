...
.site-tab-btn {
  --site-tab-accent: var(--color-accent);
  --site-tab-fill: var(--site-tab-accent);
...
.form-grid {
  display: grid;
  grid-template-columns: 142px minmax(200px, 1fr) repeat(3, 104px) max-content;
  gap: 6px;
  align-items: end;
}
